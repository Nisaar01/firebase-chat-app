    ...
    <div className="flex items-center bg-c1/[0.5] p-2 rounded-xl relative">
      ...
      {editMessage && (
        <div
          ...
          className="absolute -top-12 left-1/2 -translate-x-1/2  bg-c4 flex items-center gap-2 py-2 px-4 rounded-full text-sm font-semibold cursor-pointer shadow-lg"
        >
